...
- **[logabell/moonlight-qt-mic](https://github.com/logabell/moonlight-qt-mic)** -- independent client-side mic implementation.
  We adopted: Opus encoder settings (96 kbps, FEC, VBR, complexity 10), deadline-based send pacer with re-sync guard, 12-frame buffer overflow cap, named-device-to-default fallback, `OPUS_FRAMESIZE_20_MS` explicit frame duration.
